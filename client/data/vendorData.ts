...
export const VENDOR_PROFILES: Record<string, VendorProfile> = {
  "MarineMax Service Center": {
    ...
    licensed: true,
    yearsInBusiness: 12,
    specialties: ["Engine Service", "Mercury Authorized", "Yamaha Authorized"],
    certifications: ["Mercury Master Technician", "ABYC Certified", "Yamaha Marine Technician"],
    serviceArea: "Miami, FL · Fort Lauderdale · Biscayne Bay",
    bio: "MarineMax Service Center has been serving South Florida boaters for over 12 years. We are factory-authorized for Mercury and Yamaha outboards and specialize in multi-point inspections, engine tune-ups, and all aspects of marine service.",
    completedJobs: 847,
  },
